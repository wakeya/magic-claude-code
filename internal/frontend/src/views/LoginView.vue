<template>
  <div class="min-h-screen flex items-center justify-center bg-white relative overflow-hidden">
    ...
    <div class="w-full max-w-[400px] relative z-10 p-8">
      ...
      <p class="text-center text-text-secondary text-sm mb-9">Enter your admin password to continue</p>

      <form @submit.prevent="handleLogin">
        <div class="mb-5">
          <label class="block text-[13px] font-semibold mb-2">Password</label>
          <input
            v-model="password"
            type="password"
